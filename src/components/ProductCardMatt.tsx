...
function ProductCardMatt({ product }: { product: Product }) {
    ...
    return (
        <div className={`rounded-md w-80 bg-white flex flex-col gap-4 items-center box-shadow-black p-4 duration-700 hover:scale-105 ${product.image && product.image.includes("noimage") ? "hidden" : ""}`}>
